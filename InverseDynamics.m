...
global l m an alphan rn V1 V2 V3 V4 V5 V6 U1 U2 U3 U4 U5 U6 sn payload Rpayload;
...
U1 = [cos(thetan(1)) -sin(thetan(1)) 0; sin(thetan(1)) cos(thetan(1)) 0; 0 0 1];
U2 = [cos(thetan(2)) -sin(thetan(2)) 0; sin(thetan(2)) cos(thetan(2)) 0; 0 0 1];
U3 = eye(3);
U4 = [cos(thetan(4)) -sin(thetan(4)) 0; sin(thetan(4)) cos(thetan(4)) 0; 0 0 1];
U5 = [cos(thetan(5)) -sin(thetan(5)) 0; sin(thetan(5)) cos(thetan(5)) 0; 0 0 1];
U6 = [cos(thetan(6)) -sin(thetan(6)) 0; sin(thetan(6)) cos(thetan(6)) 0; 0 0 1];
...
% C22, C33, C66 defined earlier, for calculation of I66star

C20 = Ri0(:,:,2)*C22 + rhoi0(:,3);
C30 = Ri0(:,:,3)*C33 + rhoi0(:,4);
C60 = Ri0(:,:,6)*C66 + r60; %r60 is effectively rhoi0(:,:,7), which is the position of end effector in frame 0
